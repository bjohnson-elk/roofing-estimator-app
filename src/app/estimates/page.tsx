...
function EstimatesPageContent() {
  ...
  const [selectedViewFilter, setSelectedViewFilter] =
    useState<EstimateViewFilter>(statusFromUrl ? "All" : "Active");
  ...
  const filteredEstimates = useMemo(() => {
    return estimates.filter((estimate) => {
      const matchesView = matchesEstimateView(
        estimate.status,
        selectedViewFilter
      );
  ...
  }, [estimates, selectedStatus, selectedViewFilter, searchText]);
  ...
  return (
    <main className="min-h-screen bg-slate-100">
      <div className="flex">
        ...
        <section className="min-h-screen flex-1 lg:ml-[var(--sidebar-width)]">
